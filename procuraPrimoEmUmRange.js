...
let numeroDaVez = 0;
let primeiroN = 2; //Troque esses valores para gerar outra lista de números primos
let ultimoN = 30; //Troque esses valores para gerar outra lista de números primos
